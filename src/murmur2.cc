...
static PyMethodDef module_methods[] = {{"murmur64a", murmur2_murmur64a, METH_VARARGS, murmur64a_docstring},
                                       {NULL, NULL, 0, NULL}};

PyMODINIT_FUNC initmurmur2(void) { Py_InitModule3("murmur2", module_methods, module_docstring); }

static PyObject* murmur2_murmur64a(PyObject* self, PyObject* args) {
  const void* key = NULL;
  int len;
  uint64_t seed, hashvalue;
  if (!PyArg_ParseTuple(args, "s#l", &key, &len, &seed)) {
    return NULL;
  }
